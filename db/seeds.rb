...
#
# Reaction.create(cheer: true, jeer: false, user_id: 1, trumpet_id: 1)
# Reaction.create(cheer: true, jeer: false, user_id: 2, trumpet_id: 2)
# Reaction.create(cheer: true, jeer: false, user_id: 3, trumpet_id: 3)
Reaction.create(cheer: false, jeer: true, user_id: 2, trumpet_id: 1)
Reaction.create(cheer: false, jeer: true, user_id: 3, trumpet_id: 1)
